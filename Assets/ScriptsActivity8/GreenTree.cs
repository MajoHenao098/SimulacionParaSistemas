...
public class GreenTree : MonoBehaviour
{
    ...
    private const int index_ChildSquare = 0;
    private const int index_ChildCircle = 1;
    ...
    {
        var square = branchInstance.transform.GetChild(index_ChildSquare);
        var circle = branchInstance.transform.GetChild(index_ChildCircle);
    ...
    {
        return branchInstance.transform.GetChild(index_ChildSquare).localScale.y;
    }
}
